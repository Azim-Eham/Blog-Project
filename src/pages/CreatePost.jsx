      ...
      <div className='p-6 max-w-5xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          <div>
            ...
            <input 
              type="file" 
              accept="image/*" 
              className="w-[20vw] border dark:border-gray-500 rounded p-2"
        ...
        <div className="mt-10">
          ...
          {thumbnail && (
            ...
            <p className="text-gray-400">{excerpt || 'Excerpt will appear here...'}</p>
            <div className="mt-4 text-sm text-gray-500">{content || 'Content will appear here...'}</div>
          </div>
        </div>
      </div>
    </div>
