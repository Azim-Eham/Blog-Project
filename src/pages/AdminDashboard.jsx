        ...
        {posts.length === 0 ? (
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {posts.map(post => (
              <div
              key={post.id}
              className="border dark:border-gray-500 rounded-lg p-4 flex flex-col justify-between shadow hover:shadow-lg transition-all">
                <div>
                  {post.thumbnail && (
                    <img 
                      src={post.thumbnail} 
                  ...
                  <p className='text-gray-400 text-sm'>{post.excerpt.slice(0, 100)}...</p>
                </div>
